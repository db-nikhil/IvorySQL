...
PG_KEYWORD("exception_init", K_EXCEPTION_INIT)
...
/* deliberately absent from pl_gram.y's unreserved_keyword: "type" must stay
 * a dedicated token so it can start a "TYPE ... IS RECORD" or
 * "TYPE ... IS TABLE OF" declaration */
